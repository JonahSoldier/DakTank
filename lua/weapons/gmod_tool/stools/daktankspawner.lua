...
function TOOL.BuildCPanel( panel )
	...
	gunList["Autoloading ATGM Launcher"] = function()
		DLabel:SetText( Caliber.."mm Autoloading ATGM Launcher\n\nSimple autoloaded ATGM tube.\n\nWeapon Stats:\nWeight:        "..math.Round(0.0125*((((Caliber*6.5)*(Caliber*3)*(Caliber*3))+(math.pi*(Caliber^2)*(Caliber*50))-(math.pi*((Caliber/2)^2)*(Caliber*50)))*0.001*7.8125)/1000).." kg\nRefire Time (Mag):         "..math.Round(2*0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5))*4300,2).." seconds\nRefire Time (Carousel):  "..math.Round((2*0.225*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5))*4300)+1.1,2).." seconds\n\nSmall Mag Stats:\nMag Size:      "..math.floor(0.27*24068.224609375/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*13*ShellLength))).." rounds\nReload Time: "..math.Round((2*0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5))*4300)*math.floor(0.27*24068.224609375/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*13*ShellLength))),2).." seconds\n\nMedium Mag Stats:\nMag Size:      "..math.floor(0.27*81230.265625/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*13*ShellLength))).." rounds\nReload Time: "..math.Round((2*0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5))*4300)*math.floor(0.27*81230.265625/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*13*ShellLength))),2).." seconds\n\nLarge Mag Stats:\nMag Size:      "..math.floor(0.27*192545.796875/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*13*ShellLength))).." rounds\nReload Time: "..math.Round((2*0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5))*4300)*math.floor(0.27*192545.796875/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*13*ShellLength))),2).." seconds\n\nReload Area: "..math.Round(ShellLength*10*Caliber*0.0393701,2).." inches, back\n\nRefire and Reload times 25% shorter in modern era." )
	end
